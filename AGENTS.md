...
- `.Codex/skills/`: Automatismos para la IA (pruebas, deploys).
...
- **Levantar entorno**: Ver [deploy_local skill](file:///d:/Repositorio/jonatha1992/gestorcoc/.Codex/skills/deploy_local/skill.md)
